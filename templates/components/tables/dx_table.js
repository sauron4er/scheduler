...
import {Grid, Table, VirtualTable, TableHeaderRow, TableFilterRow, TableSummaryRow} from '@devexpress/dx-react-grid-material-ui';
import {
  SortingState,
  FilteringState,
  IntegratedSorting,
...
class DxTable extends React.PureComponent {
  ...
  render() {
    ...
    const paper_height = this.props.height && this.props.height !== null ? this.props.height : '100%';
    ...
    return (
      <Paper className='mt-2 full_width' style={{height: {paper_height}}}>
        <Grid rows={rows} columns={this.props.columns} getRowId={getRowId} style={{height: {grid_height}}} hoverStateEnabled={true}>
          ...
          <SelectionState />
          <SummaryState totalItems={this.props.summary_rows} />
