...
//TODO інфа про клієнта при перегляді візиту: телефон, нотатка, майбутні прийоми, попередні та майбутні прийоми.
//TODO можливість редагувати поля інфи клієнта прямо у вкладці
//TODO можливість видаляти майбутні прийоми прямо звідси
//TODO підчеркувати візит відповідно до кольору лікаря
